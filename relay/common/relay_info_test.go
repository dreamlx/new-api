...
func TestRelayInfoInitChannelMetaEnablesStreamOptionsForOspreyAI(t *testing.T) {
	...
	common.SetContextKey(c, constant.ContextKeyChannelType, constant.ChannelTypeOspreyAI)
...
func TestRelayInfoInitChannelMetaEnablesStreamOptionsForOpenRouter(t *testing.T) {
	...
	common.SetContextKey(c, constant.ContextKeyChannelBaseUrl, "https://openrouter.ai")
	common.SetContextKey(c, constant.ContextKeyChannelKey, "test-key")
...
func TestRelayInfoInitChannelMetaDisableStreamUsage(t *testing.T) {
	...
	common.SetContextKey(c, constant.ContextKeyChannelBaseUrl, "https://api.exchangetoken.ai")
	common.SetContextKey(c, constant.ContextKeyChannelKey, "test-key")
