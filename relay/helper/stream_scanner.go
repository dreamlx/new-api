...
func StreamScannerHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo, dataHandler func(data string, sr *StreamResult)) {
	...
	// ponytail: preserve-if-nil (not unconditional replace). relay_image.go also
	// uses this pattern; replace would discard a caller-pre-initialized
	// StreamStatus (incl. recorded errors). See commit 48b379e4a.
